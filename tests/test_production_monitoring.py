...
class TestMetricsCollection:
    ...
    def test_prometheus_metrics_format(self):
        ...
        prometheus_str = prometheus_data if isinstance(prometheus_data, str) else prometheus_data.decode()
...
class TestLoggingSystem:
    ...
    def test_business_event_logging(self):
        ...
        with patch.object(logger, 'info') as mock_info:
            log_business_event(logger, "user_signup", {"user_id": "123", "plan": "premium"})
    ...
    def test_security_event_logging(self):
        ...
        with patch.object(logger, 'error') as mock_error:
            log_security_event(logger, "failed_login_attempt", "high", {
                "user_id": "123",
    ...
    def test_performance_logging(self):
        ...
        with patch.object(logger, 'warning') as mock_warning:
            log_performance(logger, "database_query", 2.5, {"query": "SELECT * FROM users"})
