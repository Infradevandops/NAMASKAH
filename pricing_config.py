...
# Rental Pricing
RENTAL_HOURLY = {1: 1.20, 3: 1.80, 6: 2.40, 12: 3.00, 24: 3.60}
...
RENTAL_SERVICE_SPECIFIC = {7: 10.00, 14: 18.00, 30: 32.50}

RENTAL_GENERAL_USE = {7: 15.00, 14: 27.00, 30: 48.75}
...
def calculate_rental_cost(
    hours, service_name="general", mode="always_ready", auto_renew=False, bulk_count=1
):
