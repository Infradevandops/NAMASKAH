...
class PaymentInitialize(BaseModel):
    ...
    class Config:
        schema_extra = {"example": {"amount_usd": 20.0, "payment_method": "paystack"}}
...
class PaymentVerify(BaseModel):
    ...
    class Config:
        schema_extra = {"example": {"reference": "namaskah_user123_1642680000"}}
...
class SubscriptionRequest(BaseModel):
    ...
    class Config:
        schema_extra = {"example": {"plan_id": "pro"}}
