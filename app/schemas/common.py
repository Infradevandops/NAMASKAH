...
class PaginationResponse(GenericModel, Generic[T]):
    ...
    class Config:
        schema_extra = {
            "example": {"items": [], "total": 100, "page": 1, "size": 20, "pages": 5}
        }
    ...
    class Config:
        schema_extra = {
            "example": {
                ...
                "stats": {"operational": 5, "degraded": 1, "down": 0},
...
class NotificationPreferences(BaseModel):
    ...
    receipt_notifications: bool = Field(
        default=True, description="Enable receipt notifications"
    )
