...
@app.get("/verifications/active", tags=["Verification"], summary="Get Active Verifications")
def get_active_verifications(user: User = Depends(get_current_user), db: Session = Depends(get_db)):
