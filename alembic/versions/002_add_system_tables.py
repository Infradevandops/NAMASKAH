...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_service_status_service_name'), 'service_status', ['service_name'])
    op.create_index(op.f('ix_service_status_last_checked'), 'service_status', ['last_checked'])
