...
class APIKeyManager:
    ...
    def _check_rate_limit(self, key: str) -> bool:
        ...
        # Clean old requests
        self.usage_tracking[key] = [
            req_time for req_time in self.usage_tracking[key] if req_time > hour_ago
        ]
...
class WebhookManager:
    ...
    async def send_webhook(
        self, url: str, data: Dict[str, Any], secret: str = None
    ) -> bool:
    ...
    async def send_verification_webhook(
        self, webhook_url: str, verification_data: Dict[str, Any]
    ):
...
class BulkOperationManager:
    ...
    async def _create_single_verification(
...
class APIResponse:
    ...
    def validation_error(errors: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return APIResponse.error(
            "Validation failed", "VALIDATION_ERROR", {"validation_errors": errors}
        )
