...
from models.user_models import User, Session as UserSession, APIKey, UserRole, SubscriptionPlan
from auth.security import (
    hash_password, verify_password, create_access_token, create_refresh_token,
    verify_token, generate_api_key, hash_api_key, verify_api_key,
    generate_verification_token, generate_reset_token, is_strong_password
)
...
async def get_current_user(
    ...
    if api_key_record:
        ...
        if not api_key_record.last_request_date or api_key_record.last_request_date.date() != today:
