...
class ContinuousPerformanceMonitor:
    ...
    def _should_alert(self, metrics: Dict[str, Any]) -> bool:
        ...
        return (
            metrics["response_time_p95"] > self.alert_thresholds["response_time_p95"]
            or metrics["error_rate"] > self.alert_thresholds["error_rate"]
            or metrics["throughput"] < self.alert_thresholds["throughput_min"]
        )
